                ...
                <div className='flex gap-2'>
                    ...
                    <Select value={recurringFilter}
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="non-recurring">Nonrecurring Only</SelectItem>
                        </SelectContent>
                    </Select>
                        ...
                        {filteredAndSortedTransactions.length === 0 ? (
                            ...
                            filteredAndSortedTransactions.map((transaction) => (
                                <TableRow key={transaction.id} >
                                    ...
                                    <TableCell>{format(new Date(transaction.date), "PPpp")}
                                        ...
                                        {transaction.isRecurring ? (
                                            <TooltipProvider>
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent><div className='text-sm'>

                                                        <div className='font-medium'>Next Date:</div>
                                                        <div>
                                                            {format(new Date(transaction.nextRecurringDate), "PPpp")}
                                                        </div>
                                                    </div>
                                                    </TooltipContent>
                                                </Tooltip>
